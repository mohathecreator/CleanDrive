...
class AgentManager:
    ...
    def create_model(self, env, learning_rate=3e-4, tensorboard_log=None):
        ...
        Uses a two-layer MLP policy and gSDE (state-dependent exploration,
        'use_sde=True') so the exploration noise is temporally
        correlated. That directly counters the jittery steering produced by
        independent per-step Gaussian sampling.
        """
